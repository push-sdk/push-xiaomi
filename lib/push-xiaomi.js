    ...
    for (const i in registration_id) {
      axios({
        ...
        data: querystring.stringify({
          'extra.notify_effect': data['extra.notify_effect'],
          'extra.intent_uri': data['extra.intent_uri'],
          'extra.callback': data['extra.callback'],
          'extra.callback.type': data['extra.callback.type'],
        ...
        if (res.data.code == 0) {
          ...
          traceIdList.push(res.data.data.id);
